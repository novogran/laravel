...
class ProductsController extends Controller {
    ...
    {
        $products = Products::with("categories")->with("user")->get();
...
$user = User::pluck("email", "id")->prepend('Please select', null);
	    ...
	    return view('admin.products.create', compact("categories", "user", "showhide"));
	}
...
$user = User::pluck("email", "id")->prepend('Please select', null);
		...
		return view('admin.products.edit', compact('products', "categories", "user", "showhide"));
	}
